...
for (p, zfi) in zip([smb[1,1], smb[2,2]], ["../resource/eksport_796345_20240420.zip", "../resource/eksport_796340_20240420.zip"])
    ...
    if p == smb[1, 1]
        ...
        @test isfile(fn2)
        @test polygon_string(fn1) == "POLYGON ((43200 6909000, 44000 6909000, 44000 6909600, 43200 6909600, 43200 6909000),\n                   (43999 6909048, 44000 6909048, 44000 6909056, 43999 6909056, 43999 6909048))"
        @test polygon_string(fn2) == "POLYGON ((44000 6909000, 44800 6909000, 44800 6909600, 44000 6909600, 44000 6909000),\n                   (44000 6909048, 44005 6909048, 44005 6909056, 44000 6909056, 44000 6909048))"
    else
...
@testset "A" begin
    ...
    g.A[:, 1, 1] .= Float32(0)
    @test polygon_string(g) == "POLYGON ((44006 6909055, 44012 6909055, 44012 6909063, 44006 6909063, 44006 6909055),\n                   (44006 6909055, 44012 6909055, 44012 6909062, 44006 6909062, 44006 6909055))"
end
...
for p in [smb[2,2], smb[1,1] ]
    ...
    if p == smb[2, 2]
        polygon_string(g) == "POLYGON ((44006 6909055, 44012 6909055, 44012 6909063, 44006 6909063, 44006 6909055),\n                   (44006 6909056, 44011 6909056, 44011 6909063, 44006 6909063, 44006 6909056))"
    else
        @test polygon_string(g) == "POLYGON ((44000 6909047, 44006 6909047, 44006 6909055, 44000 6909055, 44000 6909047),\n                   (44000 6909048, 44005 6909048, 44005 6909055, 44000 6909055, 44000 6909048))"
    end
end
