...
for fo in ["test", "te st", "1\\2", "3 4 / 5", "..", "a/../b/c/d", ""]
    ...
    width_cell, height_cell, sheet_width_cell, sheet_height_cell, sw_corner, cell_to_utm_factor = (9, 8, 3, 4, (44000, 6909047), 2)
    smb = SheetMatrixBuilder(width_cell, height_cell, sheet_width_cell, sheet_height_cell, sw_corner, cell_to_utm_factor, fo)
    p = smb[1]
